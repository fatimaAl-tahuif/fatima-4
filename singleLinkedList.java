...
/*
يوفر كود sLinkedQueue تنفيذًا لقائمة انتظار صفية مرتبطة مفردة مع ميزات قياسية وميزات إضافية مثل الدوران والدمج.
يستخدم الكود مكتبة java.util.LinkedList للمساعدة في إدارة القائمة المرتبطة.
تم تضمين تعليقات توضيحية لتسهيل فهم الكود.
 */
