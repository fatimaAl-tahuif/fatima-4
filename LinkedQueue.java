...
/*
تستخدم فئة LinkedQueue فئة LinkedList الجاهزة لإنشاء قائمة انتظار.
تتضمن طرقًا لأضافة العناصر وحذفها والوصول إليها وتدويرها.
يمكن تعديلها لتكون قائمة انتظار عادية أو معكوسة.
 */
