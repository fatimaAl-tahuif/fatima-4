...
/*
تمثل فئة ArrauQueue قائمة انتظار صفية باستخدام مصف.
تتضمن طرقًا لأضافة العناصر وحذفها والوصول إليها ومستنسختها وطباعتها.
تستخدم طريقة rotate لتدوير القائمة بواحد.
 */